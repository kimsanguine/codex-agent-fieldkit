...
|---|---|---|---|---|
| 2026-06-22 | `make demo` | Passed | Five demo questions loaded from `data/demo_questions.txt`, including one fallback case | Offline demo path works |
| 2026-06-22 | `make test` | Passed | 5 unit tests passed through `make validate` | Covers routing, fallback, and demo file loading |
